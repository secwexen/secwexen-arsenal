...
**Secwexen Arsenal** is a collection of defensive security, OSINT, system monitoring, file management, and automation tools built for cybersecurity research and practical security workflows.
